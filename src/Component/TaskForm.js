    ...
    render() {
      var { id} = this.state
        ...
        <h3 className="panel-title">{id !== '' ? 'Cập nhật công việc' :'Thêm công việc'}</h3>
              ...
              <button type="button" className="btn btn-success" onClick = {this.onCloseForm}>Close</button>
            ...
            <div className="panel-body">
              <form onSubmit = {this.onSubmit}>
                <div className="form-group">
                  <label>Tên :</label>
                  <input type="text" className="form-control" name = "name" value= {this.state.name} onChange = {(event)=>this.onChange(event)} />
                </div>
